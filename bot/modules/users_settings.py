...
Examples:
1. <code>{escape('<b>Join: @zenupdatess</b>')}</code> 
This will give output as:
<b>Join: @zenupdatess</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>Join: @zenupdatess</code>')}</code> 
This will give output as:
<code>Join: @zenupdatess</code> <code>69MB.bin</code>.
